//Задача 52. Задайте двухмерный массив из целых чисел.Найдете среднее арифметическое в каждом столбце.
...
double[] Average(int [,] arr2D )                       // Метод находит среднее арифметическое элементов в каждом столбце 
{
