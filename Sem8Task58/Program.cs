...
MultiplayMatrix(firstMartrix, secomdMartrix, resultMatrix);
Console.WriteLine($"\nПроизведение первой и второй матриц:");
Print2DArray(resultMatrix);//выводим результат

void MultiplayMatrix(int[,] firstMartrix, int[,] secomdMartrix, int[,] resultMatrix)//метод подсчета произведения матриц 
{
