// Задача 50. Напишите программу, которая на вход принимает позиции элемента в двумерном массиве и возвращает значение этого элемена или же указание,что такого элемента нет.
...
void Print2DArrayColor(int[,] matrix)                                                                                        //метод на заполнение массива цветом
{
